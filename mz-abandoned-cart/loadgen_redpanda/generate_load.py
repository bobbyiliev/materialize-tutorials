...
# CONFIG
userSeedCount      = 100000
itemSeedCount      = 1000
purchaseGenCount   = 500000
purchaseGenEveryMS = 100
pageviewMultiplier = 25       # Translates to 75x purchases, currently 750/sec or 65M/day
...
while True:
    response = requests.get(('http://%s/connectors' % debeziumHostPort))
